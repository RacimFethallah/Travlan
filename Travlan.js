...
if (location.href.indexOf('Travlan_plan') !== -1) {
  ...
  function heb_log() {
    switch (select.value) {
      case "Logement": heb_con.classList.remove('appear'); heb_con.className = 'hide';
        heb_log_con.classList.remove('hide'); heb_log_con.className = 'appear';
        break;
      case "Hotel": heb_con.classList.remove('appear'); heb_con.className = 'hide';
        heb_hot_con.classList.remove('hide'); heb_hot_con.className = 'appear';
        break;
      case "deux": break;
    }
  }
  ...
  function heb_hot() {
    heb_hot_con.classList.remove('appear'); heb_hot_con.className = 'hide';
    heb_hot2_con.classList.remove('hide'); heb_hot2_con.className = 'appear';
