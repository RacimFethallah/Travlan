...
<h6 class="user-email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cdb4b8a6a48d80acb5baa8a1a1e3aea2a0">[email&#160;protected]</a></h6>
</div>
<div class="about">
<h5 class="mb-2 text-primary">Bio</h5>
<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laudantium, obcaecati perferendis voluptatum ut nisi excepturi sunt sit sint architecto pariatur quae necessitatibus labore dolor molestias. Est reprehenderit tenetur minima tempore!</p>
</div>
</div>
</div>
</div>
...
<input type="text" class="form-control" id="fullName" placeholder="Entrer votre nom complet">
</div>
</div>
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
<div class="form-group">
<label for="eMail">Email</label>
<input type="email" class="form-control" id="eMail" placeholder="Entrez votre addresse mail">
</div>
</div>
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
<div class="form-group">
<label for="phone">Téléphone</label>
<input type="text" class="form-control" id="phone" placeholder="Entrez votre numero de téléphone">
</div>
</div>
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
<div class="form-group">
...
<button type="button" id="submit" name="submit" class="btn btn-primary">Enregistrer</button>
</div>
</div>
</div>
</div>
